...
🎯 Project: Modern Developer Portfolio (Karan Gupta)
1. 🧠 Objective

Build a high-performance, visually premium portfolio website designed to:

Attract freelance/remote work
Showcase real projects (like SponsorGrid)
Demonstrate advanced frontend skills (3D, motion, UI)
2. 👤 Target Audience
Startup founders
Recruiters (frontend/full-stack roles)
Freelance clients
3. 🧱 Core Sections (Final Structure)
...
Subtext: performance + real-world apps

Enhancements:

Animated gradient shapes
Subtle floating motion
CTA buttons (Add manually)
2. Scroll Transition Section (Hero Exit Animation)

Component: hero-scroll-animation

Purpose:

Smooth transition from hero → content
Adds premium feel

Behavior:

Hero shrinks & rotates on scroll
Next section fades in with grid background
...
Featured project previews OR
Work highlights
3. Tech Stack Section (Interactive Skills)

Component: orbiting-skills

Purpose:

Showcase skills visually (not boring list)

Features:

Orbiting icons (HTML, CSS, JS, React, Node, Tailwind)
Glow effects
Hover labels
Pause on hover

Position:
After scroll animation section

4. Featured Projects Section (MOST IMPORTANT)

Component: PinContainer

Purpose:

Convert visitors → clients
...
SponsorGrid (main highlight)
2–3 other strong projects
5. About Section
...
6. Process Section (Optional but strong)
...
🎞️ Animations
Framer Motion
Motion One (used in scroll component)
🌌 3D / Advanced UI
(Phase 2 upgrade)
Three.js
React Three Fiber
...
npm install framer-motion motion lucide-react clsx tailwind-merge
...
Theme:
Dark (primary)
Gradient accents (indigo, cyan, purple)
Style:
Minimal + futuristic
Glassmorphism (subtle)
Glow effects (controlled)
⚠️ 7. CRITICAL RULES (FOR ANTIGRAVITY)

This is where most AI-generated sites fail:
...
Developer who builds real-world, production-ready web apps with clean UI + performance-first mindset

🏷️ Final Tagline (Use This)
...
Focused on scalable products, clean UI, and real-world impact.

🚀 Featured Projects
1. SponsorGrid (Main Highlight)
Platform for managing sponsorships & college clubs
Full-stack product
Should be visually emphasized (bigger card)
2. StrangerBlogs
Blogging platform / content system
Focus on UI + content experience
3. Arovia Vibes
Likely branding / UI-heavy project
Showcase design + frontend strength
⚙️ FINAL TECH STACK
Core:
Next.js (App Router)
React
